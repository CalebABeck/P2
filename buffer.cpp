        ...
        if(bufDescTable[clockHand].valid){
            ...
            if(bufDescTable[clockHand].pinCnt > 0){
                ...
                if(bufDescTable[clockHand].refbit){
                    ...
                    //Frame has been picked by clock algorithm, checks to see if you need to write old page back
...
* to that frame is returned otherwise a new frame is allocated from the * buffer pool for reading the page.
*/
void BufMgr::readPage(File& file, const PageId pageNo, Page*& page) {
    ...
    try{
        ...
        //Checks to see if file + page exist; if it's not the method will throw an exception
...
void BufMgr::allocPage(File& file, PageId& pageNo, Page*& page) {
    ...
    //return pointer to buffer frame allocated for the page via the page parameter
    page = &bufPool[frame];
}
    ...
    for(int i = 0; i < numBufs; i++){
        ...
        if(bufDescTable[i].file == file){
            ...
            if(bufDescTable[i].pinCnt > 0){
                throw PagePinnedException(file.filename_, bufDescTable[i].pageNo, bufDescTable[i].frameNo);
            }
            ...
            if(bufDescTable[i].dirty){
                ...
                file.writePage(bufPool[bufDescTable[i].pageNo]);
                    ...
                    //Throws BadBufferException if an invalid page belonging to file is encountered
